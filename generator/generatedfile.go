...
const vtHelpersPackage = protogen.GoImportPath("github.com/gaudiy/vtprotobuf/protohelpers")
...
const vtWellKnownPackage = protogen.GoImportPath("github.com/gaudiy/vtprotobuf/types/known/")
